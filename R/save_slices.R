...
#' @param format The format in which to save the image slice. Only 'png' and
...
#'   the `format` input.
#' @param width The width of the device. The default is 480 px for `format =
#'   'png'` and 7 inches for `format = 'pdf'`.
#' @param height The height of the device. The default is 480 px for `format =
#'   'png'` and 7 inches for `format = 'pdf'`.
#' @param units The units in which height and width are given. Can be 'px'
...
#'   'px'.
#' @param ... Arguments passed to the [oro.nifti::image()] function may be
